...
contract SampleNFT is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    event CreateSampleNFT(uint256 indexed id);
	
    constructor(string memory baseURI) ERC721("Sample NFT", "SampleNFT") {
        setBaseURI(baseURI);
        pause(true);
    }
